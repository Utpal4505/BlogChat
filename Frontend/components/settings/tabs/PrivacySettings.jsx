    ...
    <div className="max-w-2xl space-y-0">
      ...
      <div className="py-6 -mx-6 px-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-4 rounded-xl border-2 border-accent/30 dark:border-daccent/30 bg-gradient-to-br from-accent/10 to-accent/5 dark:from-daccent/10 dark:to-daccent/5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-text dark:text-dText">Google</p>
                <p className="text-xs text-muted-text dark:text-dMuted-text">
                  utpalkumar@gmail.com
                </p>
              </div>
            </div>

            <div className="flex items-center gap-2 px-3 py-1.5 bg-accent/20 dark:bg-daccent/20 rounded-full">
              <div className="w-2 h-2 rounded-full bg-accent dark:bg-daccent"></div>
              <span className="text-xs font-medium text-accent dark:text-daccent">Connected</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between p-4 rounded-xl border-2 border-bordercolor dark:border-dbordercolor bg-card/10 dark:bg-dcard/10 opacity-60">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-text dark:text-dText">X (Twitter)</p>
                <p className="text-xs text-muted-text dark:text-dMuted-text">Sign in with X</p>
              </div>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 bg-amber-500/10 rounded-full">
              ...
              <span className="text-xs font-medium text-amber-600 dark:text-amber-500">Coming Soon</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between p-4 rounded-xl border-2 border-bordercolor dark:border-dbordercolor bg-card/10 dark:bg-dcard/10 opacity-60">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-text dark:text-dText">GitHub</p>
                <p className="text-xs text-muted-text dark:text-dMuted-text">Sign in with GitHub</p>
              </div>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 bg-amber-500/10 rounded-full">
              <Wrench className="w-3.5 h-3.5 text-amber-600 dark:text-amber-500" />
        ...
        <div className="p-4 bg-gradient-to-br from-accent/10 to-accent/5 dark:from-daccent/10 dark:to-daccent/5 border border-accent/20 dark:border-daccent/20 rounded-xl">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-text dark:text-dMuted-text">
                We're working on letting you manage and disconnect social accounts. For now, your Google account is safely connected.
              </p>
            </div>
          </div>
        </div>
