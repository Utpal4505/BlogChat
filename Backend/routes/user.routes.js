...
import { createUser, getMe, getUserProfile, LoggedOutUser, LoginUser, refreshAccessToken, resetPasswordOTP, updateAvatar, updateMe, verifyOTP, verifyResetPassword } from "../controllers/user.controllers.js";
...
router.route("/username-check").get(checkUsernameLimiter,checkUsernameAvailability);
